...
4. Répétition générale du culte de mariage (échange des alliances, vœux, chants de la chorale, procession).`,
    ...
    if (existingBooks.length === 0) {
      await db.insert(libraryBooks).values([
        ...
        },
        {
          ...
          author: "Pasteur Stéphane Bamba & Dr Ruth Bamba",
    ...
    if (existingQuiz.length === 0) {
      await db.insert(quizQuestions).values([
        ...
        },
        {
          ...
          options: ["À l'amitié de David et Jonathan", "À l'amour de Christ qui s'est livré pour Son Église", "À la sagesse du Roi Salomon", "À la puissance d'Élie sur le Mont Carmel"],
          correctOptionIndex: 1,
    ...
    // 7. Seed Demo Couple: David & Ruth
    const demoCoupleSlug = "david-ruth";
    ...
    if (existingCouple.length === 0) {
      ...
      const [newCouple] = await db
        ...
        .values({
          ...
          partner1Email: "david@weddingmood.ci",
          partner2Email: "ruth@weddingmood.ci",
          partner1Role: "groom",
          partner2Role: "bride",
      ...
      await db.insert(expenses).values([
        ...
        },
        {
          ...
          requiresDualValidation: true,
          validationStatus: "pending", // Pending Ruth's validation!
          partner1Approved: true,
      ...
      await db.insert(decisions).values([
        {
          ...
          amount: 450000,
          proposalDetails: "Ruth préfère la Chorale Céleste Live pour leur répertoire de louange ivoirienne et contemporaine.",
          status: "approved",
      ...
      await db.insert(invitations).values({
        coupleId,
        slug: demoCoupleSlug,
        heroTitle: "David & Ruth – Unis par la Grâce de Dieu",
      ...
      await db.insert(dayJBlessings).values([
        ...
        { coupleId, senderName: "Jeunesse Grâce et Vie", senderRelation: "Amis de Foi", blessingText: "David et Ruth, vous êtes une source d'inspiration pour nous tous. Gloire à Dieu pour votre amour pur !", isApprovedForScreen: true },
      ...
      await db.insert(payments).values({
        ...
        amount: 3000,
        planType: "couple",
        payerEmail: "david@weddingmood.ci",
