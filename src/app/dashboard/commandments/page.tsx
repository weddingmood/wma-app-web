              ...
              <div className="pt-2 border-t border-stone-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs">
                <div className="flex items-center gap-4 text-stone-600">
                  <span className="flex items-center gap-1.5">
                    ...
                    <span>{couple?.partner1Name || "David"} : <strong>{cmd.partner1Confirmed ? "Confirmé" : "En attente"}</strong></span>
                  </span>
                  ...
                  <span className="flex items-center gap-1.5">
                    ...
                    <span>{couple?.partner2Name || "Ruth"} : <strong>{cmd.partner2Confirmed ? "Confirmé" : "En attente"}</strong></span>
                  </span>
                </div>
